...
<Image src={interaction_trigger} alt="Interaction Trigger" class="mx-auto" />
...
<Image src={state_interact} alt="State Interact" class="mx-auto" />
...
<Image src={interaction_area} alt="Interaction Area" class="mx-auto" />
